...
const routes: Routes = [
  ...
  { path: 'profile', component: ProfileComponent,canActivate:[AuthGuard],data: { role: ['ORGANIZER', 'ADMIN','USER','PROVIDER'] } },
  { path: 'create-asset', component: CreateAssetComponent,canActivate:[AuthGuard],data: {role: 'PROVIDER'} },
  ...
  { path: 'all-my-assets', component: AllEventsComponent,
    canActivate:[AuthGuard],
    data: {role: 'PROVIDER'} },
  { path: 'all-my-assets/:providerId', component: AllEventsComponent,data: {role: 'PROVIDER'} },
  ...
  {path: 'create-event', component: CreateEventComponent,canActivate:[AuthGuard],data: {role: 'ORGANIZER'}},
  ...
  {path: 'calendar', component: CalendarComponent,
    canActivate:[AuthGuard],
    data: { role: ['ORGANIZER', 'ADMIN','USER','PROVIDER'] }},
  ...
  component: GuestlistEditComponent,
  canActivate: [AuthGuard],
  data: { role: 'ORGANIZER' }},
