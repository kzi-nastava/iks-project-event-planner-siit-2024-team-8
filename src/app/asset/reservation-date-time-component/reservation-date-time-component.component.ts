...
@Component({
  selector: 'app-reservation-date-time-component',
...
export class ReservationDateTimeComponentComponent {
  ...
  constructor(
    private dialogRef: MatDialogRef<ReservationDateTimeComponentComponent>,
  ...
  reserveUtility() {
    ...
    this.budgetService.reserveUtility(this.request).subscribe(
      (response) => {
